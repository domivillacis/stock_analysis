...
Now let's dive into the technical part of our analysis. To obtain all this data, we have made use of different codes such as for loop, variables, conditionals, arrays, among others.
...
Through the use of arrays, which are practically lists, and looping through them, we have modified the code a little, to obtain the same data but with a faster running timme. In our case it has been 0.07 seconds.
